      ...
      <div style={{position:"relative" , overflow:"hidden"}} className={`${inter.className}`}>
        ...
        <main  className='w-100 overflow-hidden p-0 m-0 d-flex justify-content-center flex-wrap'>
          ...
          <div className='w-100'>
            ...
            <img src="/carve.png" className={`animation_go my-1 ${animated2 && " animate"}`} />
          </ScrollTrigger>
            </div>
            <div className='w-100 d-flex justify-content-end'>
            <ScrollTrigger onEnter={onEnterimg2} onExit={onExitimg2}>
            <img src="/carve2.png" className={`animation_go_2 my-1 ${animatedimg2 && " animate_2"}`} />
          </ScrollTrigger>
            </div>
              ...
              <div className='w-100 p-3 px-4 bg_link_input farm_text'>
                  ...
                  <div className='w-100 d-flex flex-wrap justify-content-between py-2 '>
                      <span className='col-12 d-flex p-0 m-0 align-items-center'>
                         ...
                         <img style={{position:"relative" , left:"-1%"}} src='/logo.png' className='img_farm p-0 m-0'/>
                         <b>BNB - TECAR</b>  
                      </span>
