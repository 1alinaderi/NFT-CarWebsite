...
export default function Home(props) {
  ...
  return (
    <>
      ...
      <div style={{position:"relative" , overflow:"hidden"}} className={`${inter.className}`}>
        ...
        <header className='w-100 header_bg d-flex justify-content-center align-items-center'>
            <img className='p-2' src='/favicon.ico' />
            <span className='me-4'>
              Superior Cars
            </span>
            <Link href={"/"}>
              <div className='button_home px-4 py-2'>
                Go Home
              </div>
            </Link>
        </header>
        <main  className='w-100 overflow-hidden p-0 m-0 d-flex justify-content-center flex-wrap'>
          ...
          <ScrollTrigger onEnter={onEnterViewport} onExit={onExitViewport}>
            <img src="/carve.png" className={`animation_go ${animated && " animate"}`} />
          </ScrollTrigger>
          </div>
          ...
          >
            <SwiperSlide>
              <img src='/slider1.png' className='w-100 px-4 px-sm-2' />
            </SwiperSlide>
            <SwiperSlide>
              <img src='/slider2.png' className='w-100 px-4 px-sm-2' />
            </SwiperSlide>
            <SwiperSlide>
              <img src='/slider3.png' className='w-100 px-4 px-sm-2' />
            </SwiperSlide>
          ...
          <ScrollTrigger onEnter={onEnterimg} onExit={onExitimg}>
            <img src="/carve2.png" className={`animation_go_2 ${animatedimg && " animate_2"}`} />
          </ScrollTrigger>
          </div>
          ...
          <div className='col-lg-7 col-11 col-md-8 py-3'>
              <h3 className='text-center'>Farm</h3>
              <div className='w-100 p-3 px-4 bg_link_input farm_text'>
                  ...
                  <div className='w-100 d-flex flex-wrap justify-content-between py-2 '>
                      <span className='col-12 d-flex p-0 m-0 align-items-center'>
                         ...
                         <img style={{position:"relative" , left:"-1%"}} src='/BNB.png' className='img_farm p-0 m-0'/>
                         <b>Token - BNB</b>  
                      </span>
